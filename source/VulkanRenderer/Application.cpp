...
{
	auto renderer = reinterpret_cast<Application*>(glfwGetWindowUserPointer(pWindow));
...
void Application::DestroyDebugUtilsMessegerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
{
